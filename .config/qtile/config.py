...
keys = [
    ...
    Key([mod], "r", lazy.spawn("rofi -show run"), desc="Open the rofi run menu"),
    ...
    Key([mod, "shift"], "slash", lazy.spawn([f"{scripts}/lock.sh"]), desc="Run a script to lock the screen using i3lock-color")
]
